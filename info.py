...
ADMINS = [int(admin) if id_pattern.search(admin) else admin for admin in environ.get('ADMINS', '5677019769').split()]
...
# MongoDB information
DATABASE_URI = environ.get('DATABASE_URI', "mongodb+srv://telegramban:sawann90@cluster0.lvqj39l.mongodb.net/?retryWrites=true&w=majority")
